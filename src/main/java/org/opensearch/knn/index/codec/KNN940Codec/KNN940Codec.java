...
public class KNN940Codec extends FilterCodec {
    ...
    private final KNN940PerFieldKnnVectorsFormat perFieldKnnVectorsFormat;
     ...
     */
    @Builder
    protected KNN940Codec(Codec delegate, KNN940PerFieldKnnVectorsFormat knnVectorsFormat) {

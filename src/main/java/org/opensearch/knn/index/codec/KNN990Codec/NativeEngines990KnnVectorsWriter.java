...
public class NativeEngines990KnnVectorsWriter extends KnnVectorsWriter {
    ...
    private boolean shouldSkipBuildingVectorDataStructure(final long docCount, final QuantizationState quantizationState) {
        ...
        // We will build vector data structure for 4x compression or byte scalar quantization with Faiss to avoid inconsistent scores from
        // different segments during search

...
/**
 * A {@link Lucene104ScalarQuantizedVectorsFormat} that uses a {@link PrefetchableLucene104ScalarQuantizedVectorScorer}
 * to take advantage of prefetch optimizations during search.
 */
public class PrefetchingLucene104ScalarQuantizedVectorsFormat extends Lucene104ScalarQuantizedVectorsFormat {

    private static final Lucene104ScalarQuantizedVectorScorer PREFETCHING_SCORER = new PrefetchableLucene104ScalarQuantizedVectorScorer(
    ...
    public PrefetchingLucene104ScalarQuantizedVectorsFormat(final ScalarEncoding encoding) {
        super(encoding);

...
import static org.opensearch.knn.DerivedSourceUtils.DERIVED_ENABLED_SETTINGS;
...
public class DerivedSourceIT extends DerivedSourceTestCase {
    ...
    public void testDefaultSetting() {
        ...
        createKnnIndex(indexName + "-enabled", DERIVED_ENABLED_SETTINGS, mapping);
        validateDerivedSetting(indexName + "-enabled", true);
    }
}

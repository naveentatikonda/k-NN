...
public class ModelGraveyardTests extends OpenSearchTestCase {
    ...
    public void testXContentBuilder1() throws IOException {
        ModelGraveyard testModelGraveyard = new ModelGraveyard();
        XContentBuilder xContentBuilder = XContentFactory.jsonBuilder();
        xContentBuilder.startObject();
        XContentBuilder builder = testModelGraveyard.toXContent(xContentBuilder, ToXContent.EMPTY_PARAMS);
    ...
    public void testXContentBuilder2() throws IOException {
        ...
        OpenSearchParseException ex = expectThrows(OpenSearchParseException.class, () -> ModelGraveyard.fromXContent(createParser(xContentBuilder)));

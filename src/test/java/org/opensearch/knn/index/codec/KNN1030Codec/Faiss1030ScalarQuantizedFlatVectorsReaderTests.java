...
public class Faiss1030ScalarQuantizedFlatVectorsReaderTests extends KNNTestCase {
    ...
    public void testConstructor_thenUsesScorerFromDelegate() {
        ...
        Faiss1030ScalarQuantizedFlatVectorsReader reader = new Faiss1030ScalarQuantizedFlatVectorsReader(delegate);
    ...
    public void testGetFloatVectorValues_thenReturnsWrappedValuesWithHasIndexSlice() {
        ...
        try (MockedStatic<KNN1030ScalarQuantizedUtils> mockedUtils = mockStatic(KNN1030ScalarQuantizedUtils.class)) {
            mockedUtils.when(() -> KNN1030ScalarQuantizedUtils.extractQuantizedByteVectorValues(any())).thenReturn(mockQbvv);
            ...
            mockedUtils.verify(() -> KNN1030ScalarQuantizedUtils.extractQuantizedByteVectorValues(mockFvv));
        }
    }

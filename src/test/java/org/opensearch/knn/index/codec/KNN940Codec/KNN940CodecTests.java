...
public class KNN940CodecTests extends KNNCodecTestCase {
    ...
    public void testKnnVectorIndex() throws Exception {
        ...
        var knnVectorsFormat = spy(new KNN940PerFieldKnnVectorsFormat(Optional.of(mapperService)));

        final KNN940Codec actualCodec = KNN940Codec.builder()
            .delegate(createKNN94DefaultDelegate())
            .knnVectorsFormat(knnVectorsFormat)
            .build();
        final KNN940Codec codec = KNN940Codec.builder().delegate(createKNN94DefaultDelegate()).knnVectorsFormat(knnVectorsFormat).build();

...
public class KNN1040CodecTest extends KNNCodecTestCase {
    ...
    public void testFlatFormatResolver_returnsPrefetchingFormat() {
        ...
        assertTrue(
            "Expected PrefetchingLucene104ScalarQuantizedVectorsFormat but got " + result.getClass().getSimpleName(),
            result instanceof PrefetchingLucene104ScalarQuantizedVectorsFormat
        );
    }

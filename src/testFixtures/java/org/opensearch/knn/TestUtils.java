...
public class TestUtils {
    ...
    public static final String SPACE_TYPE_INNER_PRODUCT = "innerproduct";
    public static final String SPACE_TYPE_LINF = "linf";
    public static final String SPACE_TYPE_L2 = "l2";
    ...
    public static PriorityQueue<DistVector> computeGroundTruthValues(
        ...
        for (int i = 0; i < numDocs; i++) {
            ...
            if (spaceType != null && "l1".equals(spaceType.getValue())) {
                dist = KNNScoringUtil.l1Norm(queryVector, indexVector);
            } else if (spaceType != null && "l2".equals(spaceType.getValue())) {
                dist = KNNScoringUtil.l2Squared(queryVector, indexVector);
            } else if (spaceType != null && "linf".equals(spaceType.getValue())) {
                dist = KNNScoringUtil.lInfNorm(queryVector, indexVector);
            } else if (spaceType != null && "innerproduct".equals(spaceType.getValue())) {
                dist = KNNScoringUtil.innerProduct(queryVector, indexVector);
            } else if (spaceType != null && "cosinesimil".equals(spaceType.getValue())) {
                dist = KNNScoringUtil.cosinesimil(queryVector, indexVector);
            }

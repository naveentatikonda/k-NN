        ...
        switch (getClusterType()) {
            ...
            case MIXED:
                if (isFirstMixedRound()) {
                    ...
                    validateKNNScriptScoreSearch(testIndex, TEST_FIELD, DIMENSIONS, (3 * ADD_DOCS_CNT), K, SpaceType.L2);
                }
                break;
            case UPGRADED:
                validateKNNScriptScoreSearch(testIndex, TEST_FIELD, DIMENSIONS, (3 * ADD_DOCS_CNT), K, SpaceType.L2);
                addKNNDocs(testIndex, TEST_FIELD, DIMENSIONS, 30, ADD_DOCS_CNT);
                validateKNNScriptScoreSearch(testIndex, TEST_FIELD, DIMENSIONS, (4 * ADD_DOCS_CNT), K, SpaceType.L2);
